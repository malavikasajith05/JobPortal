...
const schema = z.object({
      ...
      education: z.enum(["Intermediate", "Graduate", "Post-Graduate"], { message: "Eduacation is required",}),
      resume: z
        .any()
        .refine((file) => file instanceof FileList && file.length > 0 && ["application/pdf", "application/msword"].includes(file[0].type), {
            ...
            <Controller 
              ...
              render={({ field }) => (
                <RadioGroup onValueChange={field.onChange} {...field}>
                    ...
                    <div className="flex items-center space-x-2">
                        <RadioGroupItem value="Grauate" id="Graduate" />
